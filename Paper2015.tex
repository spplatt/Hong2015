...
\begin{figure}[t]
	\subfloat[Integral fluence rate]{\includegraphics[width=3in]{ANITAIntYieldRADECS.eps}}\\
	\subfloat[Equilethargic spectrum, normalised to fluence above \SI{10}{\MeV}]{\includegraphics[width=3in]{ANITALetYieldnormalisedRADECS.eps}}
...
% \todo{Show density of neutrons above \SI{10}{\MeV} at CUP}
    \caption{Spatial distribution of neutrons above \SI{10}{\MeV} at the Close User Position.}
