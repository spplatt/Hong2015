...
\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        ...
        \todo{
            Fig.~\ref{fig:SUPDensity} replace with 1D profile for neutrons above \SI{10}{\MeV}.
             Show position of collimator.
        }
    \end{minipage}
    \begin{minipage}{\columnwidth}
...
\todo{Check current consistency -- make \SI{215}{\nA}, check Elke's report.}
...
\begin{figure}[!t]
    ...
    \caption{
        Differential neutron spectra at CUP (upper curves) and SUP (lower curves), comparing results of this work to analytical models~\cite{Prokofiev2009,Prokofiev2014}.
        With \SI{10.2}{\cm} diameter collimator
    }
