...
These curves are normalised to neutron fluence above \SI{10}{\MeV} and presented as lethargy plots to emphasise the shape of the spectra rather than their integral fluence rate.
...
At SUP, the present results show an increased contribution below about \SI{1}{\MeV}, consistent with interactions in materials other than the target, absent from the preliminary simulations.
Fig.~\ref{fig:LethargyplotCUP} shows good agreement between the present results and the analytical fit from~\cite{Prokofiev2014}, especially in the evaporation peak around \SI{1}{\MeV} (the fit cannot reproduce the structure in this energy region).
