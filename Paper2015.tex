...
Fig.~\ref{fig:CUPProfile} shows neutron fluence profile at the CUP, compared with measurements.
In Fig.~\ref{fig:CUPProfile} simulated data were folded in energy with the neutron fission cross section for \U238~\cite{tbd}, replicating the measurements which were made with a \U238\ TFBC~\cite{Prokofiev2009}.
The results show\ldots
...
\begin{figure}[t]
    ...
    \caption{Neutron profile at the CUP, normalised to fluence rate on axis.}
