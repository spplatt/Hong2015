...
\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        \includegraphics[width=\columnwidth]{SUP10ColRadiusEffect10MeV.eps}
        \subcaption{
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{CUPTOF10beamproRADECS.eps}
    \caption{
...
\begin{figure}[t]
    \includegraphics[width=\columnwidth]{CUPTOFtofspectraRADECS.eps}
    \caption{
