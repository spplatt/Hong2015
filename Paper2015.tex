...
\captionsetup[sub]{margin={0pt,20pt}}
...
In this paper results are presented for three of these: the Standard User Position (SUP), \SI{2.5}{\m} downstream of the target centre\todo{check centre, it said that 250cm downstream of the production target in the paper}~\cite{Prokofiev2009}, the Close User Position (CUP), \SI{0.75}{\m} downstream of the target, and the CUP-TOF, \SI{0.84}{m} downstream of the target.
...
The parameterisation therefore exceeds the current calculations by tbd 31\%.\todo{Quantify integral yield}
...
\todo{Discuss the results. Compare current with earlier calculations. Compare calculations with parameterisation.}

\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        \includegraphics[width=2.5in]{ANITAIntYieldRADECS.eps}
        \subcaption{Integral fluence rate}
    \end{minipage}
    \begin{minipage}{\columnwidth}
        \includegraphics[width=2.5in]{ANITALetYieldnormalisedRADECS.eps}
        \subcaption{Equilethargic spectrum, normalised to fluence above \SI{10}{\MeV}}
    \end{minipage}
	\caption{
...
The results show\ldots
\todo{Explain what the results show: CUP measurement comparison.}
Fig.~\ref{fig:MCComparison} provides a direct comparison between the two Monte Carlo calculations.
The results show\ldots
\todo{Explain what the results show (comparison between independent MC calculations).}

\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        \todo{Integral spectra on log-log axes: CUP}
        %\includegraphics[draft,width=2.5in]{CUPTOF10beamproRADECS.png}
    	\subcaption{Integral fluence rate}
    \end{minipage}
    \begin{minipage}{\columnwidth}
        %\includegraphics[draft,width=2.5in]{CUPTOF10beamproRADECS.png}
        \todo{Normalised spectra on lethargy axes: CUP}
    	\subcaption{Equilethargic spectrum, normalised to fluence above \SI{10}{\MeV}}
    \end{minipage}
	\caption{
...
\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        \todo{Add experimental data to TOF figure (CUP)}
        \includegraphics[width=2.5in]{TOF3frameoverlap.eps}
        \subcaption{At the CUP-TOF position, with \SI{3}{\cm} collimator}
    	\label{fig:TOFFrameOverlapspectrum}
    \end{minipage}
    \begin{minipage}{\columnwidth}
        \todo{Add experimental data to TOF figure (SUP)}
        \includegraphics[width=2.5in]{SUP10frameoverlap.eps}
        \subcaption{At the SUP, with \SI{10.2}{\cm} collimator}
...
\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        %\includegraphics[draft,width=2.5in]{CUPTOF10beamproRADECS.png}
        \todo{Add gamma spatial distribution at SUP, \SI{10.2}{\cm} collimator}
        \subcaption{SUP}
        \label{fig:GammaSpatialDistributionSUP}
    \end{minipage}
    \begin{minipage}{\columnwidth}
        \todo{Add gamma spatial distribution at CUP, \SI{10.2}{\cm} collimator}
        %\includegraphics[draft,width=2.5in]{CUPTOF10beamproRADECS.png}
        \subcaption{CUP}
...
\begin{figure}[t]
    \begin{minipage}{\columnwidth}
        %\includegraphics[draft,width=2.5in]{CUPTOF10beamproRADECS.png}
        \todo{Add gamma dose versus energy at SUP, \SI{10.2}{\cm} collimator}
        \subcaption{SUP}
        \label{fig:GammaDoseEnergySUP}
    \end{minipage}
    \begin{minipage}{\columnwidth}
        %\includegraphics[draft,width=2.5in]{CUPTOF10beamproRADECS.png}
        \todo{Add gamma dose versus energy at CUP, \SI{10.2}{\cm} collimator}
        \subcaption{CUP}
