...
\begin{figure}[!t]
	\centering
	\subfloat[At the CUP-TOF position, with \SI{3}{\cm} collimator]{\todo{Add experimental data to TOF figure (CUP)\includegraphics[width=3in]{CUPTOFtofspectraRADECS.png}}
	\label{fig:TOFFrameOverlapspectrum}}\\
	\subfloat[At the SUP, with \SI{10.2}{\cm} collimator]{\todo{Add experimental data to TOF figure (SUP)}\includegraphics[width=3in]{SUPtofspectraRADECS.png}
