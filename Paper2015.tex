...
Neutron beam monitoring and characterisation at TSL includes time-of flight measurements with \U238\ TFBCs~\cite{Prokofiev14}.
Fig.~\ref{fig:TOFSpectra} compares simulated and measured TOF spectra at the CUP-TOF position.
The simulated CUP-TOF results were calculated for the \SI{3}{\cm} collimator, to match the measured data.
