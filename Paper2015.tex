...
\begin{figure}[t]
    ...
    \begin{minipage}{\columnwidth}
        ...
        \subcaption{
            CUP.
            The comparison is against the fit of Prokofiev et al.~\cite{Prokofiev2009}
        }
    \end{minipage}
	\caption{
...
Fig.~\ref{fig:DifferentialSpectra} summarises neutron spectra results by comparing differential flux as calculated in this work with fits of  models~\cite{Prokofiev2009,Prokofiev2014}.
...
\newblock{\em Proc. J. Kor. Nucl. Soc. 1980}, pp. 171-179
